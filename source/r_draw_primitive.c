...
void r_primitive_init()
{
    ...
    printf("r_primitive_init: loading r_image_pool data\n");
    r_array_load_vertex(r_image_pool, NULL, array, 0, 30);
    printf("r_primitive_init: loaded r_image_pool data\n");

    printf("r_primitive_init: loading r_surface_pool data\n");
    r_array_load_vertex(r_surface_pool, NULL, surface, 0, 6);
    printf("r_primitive_init: loaded r_surface_pool data\n");

    printf("r_primitive_init: creating color shader\n");
    ...
    printf("r_primitive_init: color shader ok\n");

    printf("r_primitive_init: creating vertex color shader\n");
    ...
    printf("r_primitive_init: vertex color shader ok\n");

    printf("r_primitive_init: creating surface shader\n");
    ...
    printf("r_primitive_init: surface shader ok\n");

    printf("r_primitive_init: creating image shader\n");
    ...
    printf("r_primitive_init: image/texture/sprite shaders ok\n");
}
