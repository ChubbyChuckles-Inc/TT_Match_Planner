...
{
    printf("r_framebuffer_init: begin\n");
    ...
    {
        printf("r_framebuffer_init: FBO extension present, loading pointers\n");
        ...
        printf("r_framebuffer_init: loaded OK\n");
        return TRUE;
    }
    printf("r_framebuffer_init: FBO extension NOT present\n");
    return FALSE;
}
